      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">wisewear@gmail.com</Typography>
            <Typography variant="body2">+92 329 1999222</Typography>
          </Grid>
          ...
          >
            ...
            <div className="mt-4 flex items-center gap-2">
              <div className="mr-4 pointer" onClick={() => window.open("https://www.instagram.com/")}>
                <svg
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
